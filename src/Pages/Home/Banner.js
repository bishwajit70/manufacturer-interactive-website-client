    ...
    return (
        <div className='grid rounded-lg bg-purple-100 lg:mt-10 p-2 lg:p-10 lg:flex gap-20 justify-between items-center'>
            <div className='w-full lg:w-1/2'>
                ...
                <p className='text-xl'>Our main focus is to produce quality product. We give the best efhtmlFort and getting the result last 40 years. Your need encourage us. </p>
